...
public class AdminController extends BaseController<Admin> {
    ...
    public String analy(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "5")int size,Model model){
        Page<Admin> pageInfo = adminService.findByPage(page,size);
        model.addAttribute("pageInfo",pageInfo);
        return "admin/analy";
    }
    ...
    public String jieshao(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "5")int size,Model model){
        Page<Admin> pageInfo = adminService.findByPage(page,size);
        model.addAttribute("pageInfo",pageInfo);
    ...
    @RequestMapping("/plan")
    public String plan(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "5")int size,Model model){
        Page<Admin> pageInfo = adminService.findByPage(page,size);
        model.addAttribute("pageInfo",pageInfo);
        return "admin/plan";
    }
