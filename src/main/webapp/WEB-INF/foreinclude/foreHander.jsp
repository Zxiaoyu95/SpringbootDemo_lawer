            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 为您提供中国西安最专业的律师推荐，法律知识推荐等信息 <span class="support-no">: (029) 8888888</span>
                        </p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-lg-8 col-md-12 col-sm-12 order-3 order-lg-2">
                    ...
                    <div class="header-feature-container mt-md-15 mt-sm-15">
                        <div class="single-feature d-flex">
                            <div class="image">
                                <i class="icon ion-md-globe" href="www.baidu.com"></i>
                            </div>
                            <div class="content">
                            </div>
                        </div>
